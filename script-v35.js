(() => {
  ...
  Object.assign(tr.ru,{
    navAccount:'Аккаунт',accountKicker:'Аккаунт и доступ',accountTitle:'Один аккаунт — на сайте и в BreakOut.',accountIntro:'Один аккаунт используется на сайте, в BreakOut для macOS и BreakOut для iOS. Статус доступа и связанные устройства собраны в личном кабинете.',createAccount:'Создать аккаунт',accountFact1Title:'Срок доступа',accountFact1Text:'В аккаунте видно, до какой даты активен BreakOut.',accountFact2Title:'Связанные устройства',accountFact2Text:'Устройства и состояние доступа можно контролировать централизованно.',accountFact3Title:'Покупка и продление',accountFact3Text:'Оплата выполняется на сайте, а доступ обновляется в приложении автоматически.',accountPageKicker:'Аккаунт BreakOut',accountPageSub:'Один аккаунт для сайта, macOS и iOS.',selectedAccess:'Выбранный доступ',password:'Пароль',repeatPassword:'Повторите пароль',forgotPassword:'Забыли пароль?',accountConsent:'Я принимаю условия использования и политику конфиденциальности.',sameLogin:'Этот же аккаунт используется в BreakOut для macOS и iOS.',accountSideKicker:'Личный кабинет',accountSideTitle:'Один аккаунт для всей экосистемы BreakOut.',accountSideIntro:'После входа здесь отображаются срок доступа и активированные устройства. Тот же аккаунт используется в приложении.',accountPreviewAccess:'Доступ',accountPreviewInactive:'Не активирован',accountPreviewPlan:'Тариф',accountPreviewDevices:'Устройства',accountSideNote:'Статус доступа появляется только после входа — без лишних пустых показателей до авторизации.',accountServerPending:'Связь с аккаунтом BreakOut настроена через Supabase.',accountResetPending:'Восстановление пароля выполняется через Supabase Auth.',accountSignedInAs:'Вы вошли как',accountValidUntil:'Действует до',accountRefresh:'Обновить статус',accountLogout:'Выйти',accountNewPasswordTitle:'Новый пароль',accountNewPasswordIntro:'Введите новый пароль для аккаунта BreakOut.',accountSavePassword:'Сохранить пароль',planSixName:'6 месяцев',planYearName:'1 год',pricingIntro:'Первый успешный вход активирует 7-дневный пробный период. Дальнейший срок доступа привязывается к аккаунту BreakOut.'
  });
  Object.assign(tr.en,{
    navAccount:'Account',accountKicker:'Account and access',accountTitle:'One account for the website and BreakOut.',accountIntro:'One account is used on the website, in BreakOut for macOS and BreakOut for iOS. Access status and connected devices live in the account portal.',createAccount:'Create account',accountFact1Title:'Access period',accountFact1Text:'Your account shows when BreakOut access expires.',accountFact2Title:'Connected devices',accountFact2Text:'Devices and access status can be managed centrally.',accountFact3Title:'Purchase and renewal',accountFact3Text:'Payment happens on the website and the app refreshes access automatically.',accountPageKicker:'BreakOut account',accountPageSub:'One account for the website, macOS and iOS.',selectedAccess:'Selected access',password:'Password',repeatPassword:'Repeat password',forgotPassword:'Forgot password?',accountConsent:'I accept the Terms of Use and Privacy Policy.',sameLogin:'Use the same account in BreakOut for macOS and iOS.',accountSideKicker:'Account portal',accountSideTitle:'One account for the BreakOut ecosystem.',accountSideIntro:'After sign-in, this page shows the access period and activated devices. The same account is used in the app.',accountPreviewAccess:'Access',accountPreviewInactive:'Inactive',accountPreviewPlan:'Plan',accountPreviewDevices:'Devices',accountSideNote:'Access status appears only after sign-in, without empty status fields before authentication.',accountServerPending:'The BreakOut account is connected through Supabase.',accountResetPending:'Password recovery is handled through Supabase Auth.',accountSignedInAs:'Signed in as',accountValidUntil:'Valid until',accountRefresh:'Refresh status',accountLogout:'Sign out',accountNewPasswordTitle:'New password',accountNewPasswordIntro:'Enter a new password for your BreakOut account.',accountSavePassword:'Save password',planSixName:'6 months',planYearName:'1 year',pricingIntro:'Your first successful sign-in activates a 7-day trial period. Continued access is linked to your BreakOut account.'
  });
