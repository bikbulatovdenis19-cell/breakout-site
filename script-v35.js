(() => {
  ...
  const tr = {
    ru:{
      ...
      pricingKicker:'Доступ',pricingTitle:'Выберите формат доступа.',pricingIntro:'Начните с 7 бесплатных дней. Платный срок доступа привязывается к аккаунту.',trialPlan:'Пробная версия',trialBadge:'7 дней',trialPrice:'Бесплатно',trialCopy:'Полный доступ к BreakOut на 7 дней после первого успешного входа в приложение.',startTrial:'Начать бесплатно',downloadPlan:'Скачать BreakOut',sixMonths:'6 месяцев',oneYear:'1 год',comingSoon:'Скоро',priceIncludes:'Доступ к функционалу BreakOut на оплаченный срок.',priceSixCopy:'Для регулярной работы в течение сезона.',priceYearCopy:'Для непрерывной работы в течение года.',chooseSix:'Выбрать 6 месяцев',chooseYear:'Выбрать 1 год',
    ...
    en:{
      ...
      pricingKicker:'Access',pricingTitle:'Choose your access.',pricingIntro:'Start with 7 free days. Paid access is linked to your account.',trialPlan:'Free trial',trialBadge:'7 days',trialPrice:'Free',trialCopy:'Full BreakOut access for 7 days after your first successful sign-in to the app.',startTrial:'Start free',downloadPlan:'Download BreakOut',sixMonths:'6 months',oneYear:'1 year',comingSoon:'Coming soon',priceIncludes:'Access to BreakOut functionality for the paid term.',priceSixCopy:'For regular work throughout the season.',priceYearCopy:'For continuous work throughout the year.',chooseSix:'Choose 6 months',chooseYear:'Choose 1 year',
