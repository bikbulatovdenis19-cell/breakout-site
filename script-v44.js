(() => {
  ...
  const tr = {
    ru:{
      ...
      eyebrow:'Профессиональный спортивный видеоанализ для Mac + iPhone',heroTitle:'Видеть игру.\nОтмечать главное.',heroLead:'Анализируйте матч на Mac, отправляйте связанные эпизоды на iPhone и возвращайте рисунки и комментарии прямо в исходный проект. BreakOut объединяет видео, события и мобильный разбор в одной локальной экосистеме.',tryDemo:'Попробовать демо',download:'Скачать для macOS',iosButton:'BreakOut для iPhone',forMac:'Для Mac',foriPhone:'Для iPhone',iosCompanion:'BreakOut companion',macRequirement:'macOS 12.5 и новее',modulesAvailable:'основных модулей в одном пространстве',realInterface:'Реальный интерфейс BreakOut',
    ...
    en:{
      ...
      eyebrow:'Professional sports video analysis for Mac + iPhone',heroTitle:'See the game.\nMark what matters.',heroLead:'Analyze the match on Mac, send linked events to iPhone, then return drawings and review notes directly to the source project. BreakOut brings video, events and mobile review into one local ecosystem.',tryDemo:'Try the demo',download:'Download for macOS',iosButton:'BreakOut for iPhone',forMac:'For Mac',foriPhone:'For iPhone',iosCompanion:'BreakOut companion',macRequirement:'macOS 12.5 or later',modulesAvailable:'core modules in one workspace',realInterface:'Real BreakOut interface',
  ...
  Object.assign(tr.ru,{
    navAccount:'Аккаунт',developmentKicker:'Экосистема BreakOut',developmentTitle:'Работайте на Mac. Берите результат с собой.',developmentIntro:'BreakOut macOS остаётся основным рабочим инструментом для анализа. Отправьте текущий эпизод на iPhone, разберите его в мобильном BreakOut и верните рисунки, текст и комментарий именно в исходную метку проекта.',developmentPlatforms:'Один аккаунт. Видео напрямую на iPhone. Изменения — обратно в исходный проект.',ecoStep1:'Анализ на Mac',ecoStep2:'BreakOut Link',ecoStep3:'Разбор iPhone → Mac',macPlatformRole:'Анализ · Timeline · Composer · Drawing',iosPlatformRole:'Library · Drawing · Review · Offline',platformDownloadFor:'Скачать для',macAvailable:'ДОСТУПНО',iosAvailable:'ДОСТУПНО',windowsInDevelopment:'В РАЗРАБОТКЕ',accountKicker:'Доступ к BreakOut',accountTitle:'Начните бесплатно. Продолжайте, когда будете готовы.',accountIntro:'Один BreakOut Account используется на Mac, iPhone и сайте. В нём хранятся доступ и доверенные устройства, а персональный QR-код связывает ваш Mac с мобильным BreakOut.',createAccount:'Создать аккаунт',accountFact1Title:'7 дней бесплатно',accountFact1Text:'Полный доступ начинается после первого успешного входа в BreakOut.',accountFact2Title:'Срок всегда под рукой',accountFact2Text:'В кабинете видны лицензированный Mac и связанные iPhone или iPad.',accountFact3Title:'Продление без ключей',accountFact3Text:'После покупки срок доступа обновляется в аккаунте и приложении.',accountPageKicker:'Аккаунт BreakOut',accountPageSub:'',selectedAccess:'Выбранный доступ',password:'Пароль',repeatPassword:'Повторите пароль',forgotPassword:'Забыли пароль?',accountConsent:'Я принимаю условия использования и политику конфиденциальности.',sameLogin:'Этот же аккаунт используется в BreakOut для macOS и iOS.',accountSideKicker:'Личный кабинет',accountSideTitle:'Управляйте доступом к BreakOut.',accountSideIntro:'Один аккаунт для BreakOut на Mac, iPhone и сайте — со статусом доступа и связанными устройствами.',accountPreviewAccess:'Доступ',accountPreviewInactive:'Не активирован',accountPreviewPlan:'Тариф',accountPreviewDevices:'Устройства',accountSideNote:'Статус доступа появляется только после входа — без лишних пустых показателей до авторизации.',accountServerPending:'Связь с аккаунтом BreakOut настроена через Supabase.',accountResetPending:'Восстановление пароля выполняется через Supabase Auth.',accountSignedInAs:'Аккаунт',accountValidUntil:'Действует до',accountLastSync:'Обновлено',accountConnectedMac:'BreakOut для macOS',accountConnectedMobile:'BreakOut для iOS',accountRefresh:'Обновить статус',accountLogout:'Выйти',accountNewPasswordTitle:'Новый пароль',accountNewPasswordIntro:'Введите новый пароль для аккаунта BreakOut.',accountSavePassword:'Сохранить пароль',planMonthName:'1 месяц',planSixName:'6 месяцев',planYearName:'1 год',trialShort:'7 дней',popularPlan:'Популярный',pricingIntro:'Первый успешный вход активирует 7-дневный пробный период. Затем можно выбрать доступ на 1 месяц, 6 месяцев или 1 год.'
  });
  Object.assign(tr.en,{
    navAccount:'Account',developmentKicker:'BreakOut ecosystem',developmentTitle:'Work on Mac. Take the result with you.',developmentIntro:'BreakOut macOS remains the primary analysis workspace. Send the current event to iPhone, review it in mobile BreakOut, then return drawings, text and notes directly to the original project event.',developmentPlatforms:'One account. Video direct to iPhone. Review changes return to the source project.',ecoStep1:'Analyze on Mac',ecoStep2:'BreakOut Link',ecoStep3:'iPhone review → Mac',macPlatformRole:'Analysis · Timeline · Composer · Drawing',iosPlatformRole:'Library · Drawing · Review · Offline',platformDownloadFor:'Download for',macAvailable:'AVAILABLE',iosAvailable:'AVAILABLE',windowsInDevelopment:'IN DEVELOPMENT',accountKicker:'BreakOut access',accountTitle:'Start free. Continue when you are ready.',accountIntro:'One BreakOut Account is used on Mac, iPhone and the website. It keeps access and trusted devices together, while a personal QR code links your Mac to mobile BreakOut.',createAccount:'Create account',accountFact1Title:'7 days free',accountFact1Text:'Full access starts after your first successful sign-in to BreakOut.',accountFact2Title:'Access at a glance',accountFact2Text:'The portal shows your licensed Mac and connected iPhone or iPad.',accountFact3Title:'Renew without keys',accountFact3Text:'After purchase, your access period updates in the account and the app.',accountPageKicker:'BreakOut account',accountPageSub:'',selectedAccess:'Selected access',password:'Password',repeatPassword:'Repeat password',forgotPassword:'Forgot password?',accountConsent:'I accept the Terms of Use and Privacy Policy.',sameLogin:'Use the same account in BreakOut for macOS and iOS.',accountSideKicker:'Account portal',accountSideTitle:'Manage your BreakOut access.',accountSideIntro:'One account for BreakOut on Mac, iPhone and the website, with access status and connected devices.',accountPreviewAccess:'Access',accountPreviewInactive:'Inactive',accountPreviewPlan:'Plan',accountPreviewDevices:'Devices',accountSideNote:'Access status appears only after sign-in, without empty status fields before authentication.',accountServerPending:'The BreakOut account is connected through Supabase.',accountResetPending:'Password recovery is handled through Supabase Auth.',accountSignedInAs:'Account',accountValidUntil:'Valid until',accountLastSync:'Updated',accountConnectedMac:'BreakOut for macOS',accountConnectedMobile:'BreakOut for iOS',accountRefresh:'Refresh status',accountLogout:'Sign out',accountNewPasswordTitle:'New password',accountNewPasswordIntro:'Enter a new password for your BreakOut account.',accountSavePassword:'Save password',planMonthName:'1 month',planSixName:'6 months',planYearName:'1 year',trialShort:'7 days',popularPlan:'Popular',pricingIntro:'Your first successful sign-in activates a 7-day trial period. Then choose 1 month, 6 months or 1 year of access.'
  });
