# BreakOut Website v17 — Supabase account integration
...
- Uses unique v17 CSS/JS/config filenames and build query parameters to bypass stale Safari/GitHub Pages caches.
