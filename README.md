# BreakOut Website v16 — Supabase account integration
...
- Uses unique v16 CSS/JS/config filenames and build query parameters to bypass stale Safari/GitHub Pages caches.
