(() => {
  ...
  const tr = {
    ru:{
      ...
      modalTitle:'Функция пока недоступна',modalBody:'Публичная загрузка, вход и оплата будут подключены позже.',modalDownload:'Публичная загрузка BreakOut пока не открыта.',modalAccount:'Вход в аккаунт BreakOut появится позже.',modalPayment:'Оплата пока не подключена. Никакого списания не произойдёт.',close:'Закрыть',
      ...
      backHome:'← На главную',supportTitle:'Поддержка',supportIntro:'Помощь по BreakOut для macOS: установка, доступ, работа приложения и вопросы по продукту.',supportEmailTitle:'Поддержка по e-mail',supportEmailCopy:'Для технических вопросов, отзывов о программе и вопросов по доступу.',supportEmailButton:'Написать',supportAccessTitle:'Загрузка и доступ',supportAccessCopy:'Аккаунт уже используется для тестового входа и проверки доступа. Публичная загрузка приложения будет открыта к коммерческому запуску.',supportAccessButton:'Посмотреть тарифы',supportBeforeTitle:'Если возникла техническая проблема',supportBeforeCopy:'Укажите версию BreakOut, версию macOS, что вы делали перед ошибкой и точный текст сообщения. Если проблема видна на экране, приложите скриншот.',supportPaymentsTitle:'Оплата и подписка',supportPaymentsCopy:'После запуска продаж в аккаунте BreakOut можно будет видеть информацию о доступе и подписке.',
  ...
  Object.assign(tr.ru,{
    navAccount:'Аккаунт',accountKicker:'Аккаунт и доступ',accountTitle:'Один аккаунт — на сайте и в BreakOut.',accountIntro:'Создайте аккаунт, выберите срок доступа и войдите тем же e-mail в приложении на Mac. Статус доступа и активированные устройства будут собраны в личном кабинете.',createAccount:'Создать аккаунт',accountFact1Title:'Срок доступа',accountFact1Text:'В аккаунте видно, до какой даты активен BreakOut.',accountFact2Title:'Активированные Mac',accountFact2Text:'Устройства и состояние доступа можно контролировать централизованно.',accountFact3Title:'Покупка и продление',accountFact3Text:'Оплата выполняется на сайте, а доступ обновляется в приложении автоматически.',accountPageKicker:'Аккаунт BreakOut',accountPageSub:'Один аккаунт для сайта и приложения на Mac.',selectedAccess:'Выбранный доступ',password:'Пароль',repeatPassword:'Повторите пароль',forgotPassword:'Забыли пароль?',accountConsent:'Я принимаю условия использования и политику конфиденциальности.',sameLogin:'Этот же аккаунт используется для входа в BreakOut на Mac.',accountSideKicker:'Личный кабинет',accountSideTitle:'Один аккаунт для сайта и BreakOut на Mac.',accountSideIntro:'После входа здесь отображаются срок доступа и активированные устройства. Тот же аккаунт используется в приложении.',accountPreviewAccess:'Доступ',accountPreviewInactive:'Не активирован',accountPreviewPlan:'Тариф',accountPreviewDevices:'Устройства',accountSideNote:'Статус доступа появляется только после входа — без лишних пустых показателей до авторизации.',accountServerPending:'Связь с аккаунтом BreakOut настроена через Supabase.',accountResetPending:'Восстановление пароля выполняется через Supabase Auth.',accountSignedInAs:'Вы вошли как',accountValidUntil:'Действует до',accountRefresh:'Обновить статус',accountLogout:'Выйти',accountNewPasswordTitle:'Новый пароль',accountNewPasswordIntro:'Введите новый пароль для аккаунта BreakOut.',accountSavePassword:'Сохранить пароль',planSixName:'6 месяцев',planYearName:'1 год',pricingIntro:'Выберите срок доступа. После оплаты он будет привязан к аккаунту BreakOut и станет доступен в приложении на Mac.'
  });
  Object.assign(tr.en,{
    navAccount:'Account',accountKicker:'Account and access',accountTitle:'One account for the website and BreakOut.',accountIntro:'Create an account, choose an access period and use the same email to sign in to the Mac app. Access status and activated devices will live in the account portal.',createAccount:'Create account',accountFact1Title:'Access period',accountFact1Text:'Your account shows when BreakOut access expires.',accountFact2Title:'Activated Macs',accountFact2Text:'Devices and access status can be managed centrally.',accountFact3Title:'Purchase and renewal',accountFact3Text:'Payment happens on the website and the app refreshes access automatically.',accountPageKicker:'BreakOut account',accountPageSub:'One account for the website and the Mac app.',selectedAccess:'Selected access',password:'Password',repeatPassword:'Repeat password',forgotPassword:'Forgot password?',accountConsent:'I accept the Terms of Use and Privacy Policy.',sameLogin:'Use the same account to sign in to BreakOut on Mac.',accountSideKicker:'Account portal',accountSideTitle:'One account for the website and BreakOut on Mac.',accountSideIntro:'After sign-in, this page shows the access period and activated devices. The same account is used in the app.',accountPreviewAccess:'Access',accountPreviewInactive:'Inactive',accountPreviewPlan:'Plan',accountPreviewDevices:'Devices',accountSideNote:'Access status appears only after sign-in, without empty status fields before authentication.',accountServerPending:'The BreakOut account is connected through Supabase.',accountResetPending:'Password recovery is handled through Supabase Auth.',accountSignedInAs:'Signed in as',accountValidUntil:'Valid until',accountRefresh:'Refresh status',accountLogout:'Sign out',accountNewPasswordTitle:'New password',accountNewPasswordIntro:'Enter a new password for your BreakOut account.',accountSavePassword:'Save password',planSixName:'6 months',planYearName:'1 year',pricingIntro:'Choose an access period. After payment it will be attached to your BreakOut account and available in the Mac app.'
  });
  ...
  if(signInForm && registerForm){
    ...
    function showAuth(next='signin'){
      ...
      if(planBox){if(mode==='register'&&plan){show(planBox);if(plan==='6m'){planName.textContent=t('planSixName')||'6 месяцев';planPrice.textContent='25 000 ₽'}else if(plan==='1y'){planName.textContent=t('planYearName')||'1 год';planPrice.textContent='50 000 ₽'}else hide(planBox)}else hide(planBox)}
