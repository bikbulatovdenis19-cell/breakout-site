(() => {
  ...
  if(signInForm && registerForm){
    ...
    function planText(v){if(v==='monthly')return t('planMonthName')||'1 месяц';if(v==='six_months')return t('planSixName')||'6 месяцев';if(v==='annual')return t('planYearName')||'1 год';if(v==='trial')return message('Пробный доступ','Trial');if(v==='complimentary')return message('Тестовый доступ','Test access');return'—'}
