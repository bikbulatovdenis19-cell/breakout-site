window.BREAKOUT_CONFIG = {
  ...
  downloadURL: "",
  accountURL: "account.html?build=20",
  signInURL: "account.html?build=20&mode=signin",
  registerURL: "account.html?build=20&mode=register",
  purchaseMonthlyURL: "account.html?build=20&mode=register&plan=1m",
  purchaseSixMonthsURL: "account.html?build=20&mode=register&plan=6m",
  purchaseAnnualURL: "account.html?build=20&mode=register&plan=1y",
