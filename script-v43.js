(() => {
  ...
  const tr = {
    ...
    en:{
      ...
      eyebrow:'Professional sports video analysis for Mac + iPhone',heroTitle:'See the game.\nMark what matters.',heroLead:'Analyze the match on Mac, save finished clips and continue on iPhone. BreakOut brings video, events, drawings, collections and a local mobile library into one ecosystem.',tryDemo:'Try the demo',download:'Download for macOS',iosButton:'BreakOut for iPhone',forMac:'For Mac',foriPhone:'For iPhone',iosCompanion:'BreakOut companion',macRequirement:'macOS 12.5 or later',modulesAvailable:'core modules in one workspace',realInterface:'Real BreakOut interface',
