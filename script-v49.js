(() => {
  ...
  const tr = {
    ...
    en:{
      ...
      eyebrow:'Professional video analyst platform for macOS and iOS',heroTitle:'See the game.\nMark what matters.',heroLead:'Tag game moments on Mac, build them in Composer and send them to the coaching staff on iPhone or iPad. Drawings, notes and tactics stay linked to the source project.',tryDemo:'Try the demo',download:'Download for macOS',iosButton:'Download for iOS',forMac:'For Mac',foriPhone:'For iOS',iosCompanion:'BreakOut companion',macRequirement:'macOS 14 or later',modulesAvailable:'core modules in one workspace',realInterface:'Real BreakOut interface',
